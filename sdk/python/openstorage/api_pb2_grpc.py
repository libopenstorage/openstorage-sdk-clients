...
class OpenStorageFilesystemTrimStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AutoFSTrimStatus = channel.unary_unary(
                '/openstorage.api.OpenStorageFilesystemTrim/AutoFSTrimStatus',
...
class OpenStorageFilesystemTrimServicer(object):
    ...
    def AutoFSTrimStatus(self, request, context):
...
def add_OpenStorageFilesystemTrimServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AutoFSTrimStatus': grpc.unary_unary_rpc_method_handler(
...
class OpenStorageFilesystemCheckStub(object):
    ...
    **Note:
    ...
    def __init__(self, channel):
        ...
        self.Status = channel.unary_unary(
                '/openstorage.api.OpenStorageFilesystemCheck/Status',
                request_serializer=api__pb2.SdkFilesystemCheckStatusRequest.SerializeToString,
                response_deserializer=api__pb2.SdkFilesystemCheckStatusResponse.FromString,
                )
        self.Stop = channel.unary_unary(
...
def add_OpenStorageFilesystemCheckServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Status': grpc.unary_unary_rpc_method_handler(
                    servicer.Status,
                    request_deserializer=api__pb2.SdkFilesystemCheckStatusRequest.FromString,
                    response_serializer=api__pb2.SdkFilesystemCheckStatusResponse.SerializeToString,
            ),
            'Stop': grpc.unary_unary_rpc_method_handler(
                    servicer.Stop,
...
class OpenStorageFilesystemCheck(object):
    ...
    **Note:
    ...
    def Status(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/openstorage.api.OpenStorageFilesystemCheck/Status',
...
class OpenStorageBucketStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.Create = channel.unary_unary(
                '/openstorage.api.OpenStorageBucket/Create',
                request_serializer=api__pb2.BucketCreateRequest.SerializeToString,
                response_deserializer=api__pb2.BucketCreateResponse.FromString,
                )
        self.Delete = channel.unary_unary(
                '/openstorage.api.OpenStorageBucket/Delete',
                request_serializer=api__pb2.BucketDeleteRequest.SerializeToString,
                response_deserializer=api__pb2.BucketDeleteResponse.FromString,
                )
        self.GrantAccess = channel.unary_unary(
                '/openstorage.api.OpenStorageBucket/GrantAccess',
                request_serializer=api__pb2.BucketGrantAccessRequest.SerializeToString,
                response_deserializer=api__pb2.BucketGrantAccessResponse.FromString,
                )
        self.RevokeAccess = channel.unary_unary(
                '/openstorage.api.OpenStorageBucket/RevokeAccess',
                request_serializer=api__pb2.BucketRevokeAccessRequest.SerializeToString,
                response_deserializer=api__pb2.BucketRevokeAccessResponse.FromString,
                )


class OpenStorageBucketServicer(object):
    """BucketService to manage the bucket driver
    """
...
def add_OpenStorageBucketServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Create': grpc.unary_unary_rpc_method_handler(
                    servicer.Create,
                    request_deserializer=api__pb2.BucketCreateRequest.FromString,
                    response_serializer=api__pb2.BucketCreateResponse.SerializeToString,
            ),
            'Delete': grpc.unary_unary_rpc_method_handler(
                    servicer.Delete,
                    request_deserializer=api__pb2.BucketDeleteRequest.FromString,
                    response_serializer=api__pb2.BucketDeleteResponse.SerializeToString,
            ),
            'GrantAccess': grpc.unary_unary_rpc_method_handler(
                    servicer.GrantAccess,
                    request_deserializer=api__pb2.BucketGrantAccessRequest.FromString,
                    response_serializer=api__pb2.BucketGrantAccessResponse.SerializeToString,
            ),
            'RevokeAccess': grpc.unary_unary_rpc_method_handler(
                    servicer.RevokeAccess,
                    request_deserializer=api__pb2.BucketRevokeAccessRequest.FromString,
                    response_serializer=api__pb2.BucketRevokeAccessResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'openstorage.api.OpenStorageBucket', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class OpenStorageBucket(object):
    """BucketService to manage the bucket driver
    """
    ...
    def Create(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/openstorage.api.OpenStorageBucket/Create',
            api__pb2.BucketCreateRequest.SerializeToString,
            api__pb2.BucketCreateResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Delete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/openstorage.api.OpenStorageBucket/Delete',
            api__pb2.BucketDeleteRequest.SerializeToString,
            api__pb2.BucketDeleteResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GrantAccess(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/openstorage.api.OpenStorageBucket/GrantAccess',
            api__pb2.BucketGrantAccessRequest.SerializeToString,
            api__pb2.BucketGrantAccessResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def RevokeAccess(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/openstorage.api.OpenStorageBucket/RevokeAccess',
            api__pb2.BucketRevokeAccessRequest.SerializeToString,
            api__pb2.BucketRevokeAccessResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
