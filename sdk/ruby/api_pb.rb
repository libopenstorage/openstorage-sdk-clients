...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("api.proto", :syntax => :proto3) do
    add_message "openstorage.api.StorageResource" do
      ...
      optional :cloud_drive_type, :string, 16
    end
    ...
    add_message "openstorage.api.SchedulerTopology" do
    ...
    add_message "openstorage.api.TopologyRequirement" do
      map :labels, :string, :string, 1
    end
    ...
    add_message "openstorage.api.PureBlockSpec" do
      optional :serial_num, :string, 1
      optional :full_vol_name, :string, 2
    end
    add_message "openstorage.api.PureFileSpec" do
      optional :export_rules, :string, 1
      optional :full_vol_name, :string, 2
    end
    add_message "openstorage.api.ProxySpec" do
      ...
      optional :pure_block_spec, :message, 6, "openstorage.api.PureBlockSpec"
      optional :pure_file_spec, :message, 7, "openstorage.api.PureFileSpec"
    end
    ...
    add_message "openstorage.api.IoThrottle" do
      optional :read_iops, :uint32, 1
      optional :write_iops, :uint32, 2
      optional :read_bw_mbytes, :uint32, 3
      optional :write_bw_mbytes, :uint32, 4
    end
    add_message "openstorage.api.VolumeSpec" do
      ...
      optional :sharedv4_spec, :message, 43, "openstorage.api.Sharedv4Spec"
      optional :auto_fstrim, :bool, 44
      optional :io_throttle, :message, 45, "openstorage.api.IoThrottle"
      optional :number_of_chunks, :uint32, 46
      ...
      optional :near_sync, :bool, 51
      optional :near_sync_replication_strategy, :enum, 52, "openstorage.api.NearSyncReplicationStrategy"
      optional :checksum_clone_id, :string, 53
      optional :checksummed, :bool, 54
    end
    add_message "openstorage.api.VolumeSpecUpdate" do
      ...
      oneof :sharedv4_spec_opt do
        optional :sharedv4_spec, :message, 38, "openstorage.api.Sharedv4Spec"
      end
      oneof :auto_fstrim_opt do
        optional :auto_fstrim, :bool, 39
      end
      oneof :io_throttle_opt do
        optional :io_throttle, :message, 40, "openstorage.api.IoThrottle"
      end
      oneof :readahead_opt do
        optional :readahead, :bool, 41
      end
      oneof :winshare_opt do
        optional :winshare, :bool, 42
      end
      oneof :near_sync_replication_strategy_opt do
        optional :near_sync_replication_strategy, :enum, 43, "openstorage.api.NearSyncReplicationStrategy"
      end
      oneof :checksummed_opt do
        optional :checksummed, :bool, 44
      end
    end
    add_message "openstorage.api.VolumeSpecPolicy" do
      ...
      oneof :sharedv4_service_spec_opt do
        optional :sharedv4_service_spec, :message, 63, "openstorage.api.Sharedv4ServiceSpec"
      end
      oneof :sharedv4_spec_opt do
        optional :sharedv4_spec, :message, 64, "openstorage.api.Sharedv4Spec"
      end
      oneof :auto_fstrim_opt do
        optional :auto_fstrim, :bool, 65
      end
      oneof :io_throttle_opt do
        optional :io_throttle, :message, 66, "openstorage.api.IoThrottle"
      end
      oneof :readahead_opt do
        optional :readahead, :bool, 67
      end
      oneof :winshare_opt do
        optional :winshare, :bool, 68
      end
    end
    ...
    add_message "openstorage.api.Volume" do
      ...
      optional :derived_io_profile, :enum, 31, "openstorage.api.IoProfile"
      optional :in_trashcan, :bool, 32
    end
    add_message "openstorage.api.Stats" do
      ...
      optional :discards, :uint64, 11
      optional :discard_ms, :uint64, 12
      optional :discard_bytes, :uint64, 13
      optional :unique_blocks, :uint64, 14
    end
    ...
    add_message "openstorage.api.VolumeBytesUsed" do
      optional :volume_id, :string, 1
      optional :total_bytes, :uint64, 2
    end
    add_message "openstorage.api.VolumeBytesUsedByNode" do
      optional :node_id, :string, 1
      repeated :vol_usage, :message, 2, "openstorage.api.VolumeBytesUsed"
    end
    ...
    add_message "openstorage.api.StorageNode" do
      ...
      optional :scheduler_topology, :message, 20, "openstorage.api.SchedulerTopology"
      optional :non_quorum_member, :bool, 22
    end
    ...
    add_message "openstorage.api.BucketCreateRequest" do
      optional :name, :string, 1
      optional :region, :string, 2
      optional :endpoint, :string, 3
      optional :anonymousBucketAccessMode, :enum, 4, "openstorage.api.AnonymousBucketAccessMode"
    end
    add_message "openstorage.api.BucketCreateResponse" do
      optional :bucket_id, :string, 1
    end
    add_message "openstorage.api.BucketDeleteRequest" do
      optional :bucket_id, :string, 1
      optional :region, :string, 2
      optional :endpoint, :string, 3
      optional :clear_bucket, :bool, 4
    end
    add_message "openstorage.api.BucketDeleteResponse" do
    end
    add_message "openstorage.api.BucketGrantAccessRequest" do
      optional :bucket_id, :string, 1
      optional :account_name, :string, 2
      optional :access_policy, :string, 3
    end
    add_message "openstorage.api.BucketGrantAccessResponse" do
      optional :account_id, :string, 1
      optional :credentials, :message, 2, "openstorage.api.BucketAccessCredentials"
    end
    add_message "openstorage.api.BucketRevokeAccessRequest" do
      optional :bucket_id, :string, 1
      optional :account_id, :string, 2
    end
    add_message "openstorage.api.BucketRevokeAccessResponse" do
    end
    add_message "openstorage.api.BucketAccessCredentials" do
    ...
    add_message "openstorage.api.SdkCredentialCreateRequest" do
      ...
      oneof :credential_type do
        ...
        optional :nfs_credential, :message, 203, "openstorage.api.SdkNfsCredentialRequest"
      end
    end
    add_message "openstorage.api.SdkCredentialCreateResponse" do
      optional :credential_id, :string, 1
    end
    add_message "openstorage.api.SdkCredentialUpdateRequest" do
      optional :credential_id, :string, 1
      optional :update_req, :message, 2, "openstorage.api.SdkCredentialCreateRequest"
    end
    add_message "openstorage.api.SdkCredentialUpdateResponse" do
    end
    ...
    add_message "openstorage.api.SdkNfsCredentialRequest" do
      optional :server, :string, 1
      optional :sub_path, :string, 2
      optional :mount_opts, :string, 3
      optional :timeout_seconds, :uint32, 4
    end
    ...
    add_message "openstorage.api.SdkNfsCredentialResponse" do
      optional :server, :string, 1
      optional :sub_path, :string, 2
      optional :mount_opts, :string, 3
      optional :timeout_seconds, :uint32, 4
    ...
    add_message "openstorage.api.SdkCredentialInspectResponse" do
      ...
      oneof :credential_type do
        ...
        optional :nfs_credential, :message, 203, "openstorage.api.SdkNfsCredentialResponse"
      end
    end
    ...
    add_message "openstorage.api.SdkVolumeCloneRequest" do
      ...
      map :additional_labels, :string, :string, 3
    end
    ...
    add_message "openstorage.api.SdkWatchRequest" do
      oneof :event_type do
        optional :volume_event, :message, 1, "openstorage.api.SdkVolumeWatchRequest"
      end
    end
    add_message "openstorage.api.SdkWatchResponse" do
      oneof :event_type do
        optional :volume_event, :message, 1, "openstorage.api.SdkVolumeWatchResponse"
      end
    end
    add_message "openstorage.api.SdkVolumeWatchRequest" do
      map :labels, :string, :string, 1
    end
    add_message "openstorage.api.SdkVolumeWatchResponse" do
      optional :volume, :message, 1, "openstorage.api.Volume"
      optional :name, :string, 2
    end
    ...
    add_message "openstorage.api.SdkNodeRelaxedReclaimPurgeRequest" do
      optional :node_id, :string, 1
    end
    add_message "openstorage.api.SdkNodeRelaxedReclaimPurgeResponse" do
      optional :status, :message, 1, "openstorage.api.RelaxedReclaimPurge"
    end
    ...
    add_message "openstorage.api.Job" do
      ...
      oneof :job do
        ...
        optional :defrag, :message, 403, "openstorage.api.DefragJob"
      end
    end
    ...
    add_message "openstorage.api.DefragJob" do
      optional :max_duration_hours, :double, 1
      optional :max_nodes_in_parallel, :uint32, 2
      repeated :include_nodes, :string, 3
      repeated :exclude_nodes, :string, 4
      repeated :node_selector, :string, 5
      repeated :current_running_nodes, :string, 6
      optional :schedule_id, :string, 7
    end
    ...
    add_message "openstorage.api.SdkStorageRebalanceRequest" do
      ...
      optional :mode, :enum, 7, "openstorage.api.SdkStorageRebalanceRequest.Mode"
    end
    add_enum "openstorage.api.SdkStorageRebalanceRequest.Mode" do
      value :STORAGE_REBALANCE, 0
      value :VOLUME_PLACEMENT_FIX, 1
    end
    ...
    add_message "openstorage.api.RebalanceScheduleInfo" do
      optional :schedule, :string, 1
      repeated :rebalance_requests, :message, 2, "openstorage.api.SdkStorageRebalanceRequest"
      optional :create_time, :message, 3, "google.protobuf.Timestamp"
    end
    add_message "openstorage.api.SdkCreateRebalanceScheduleRequest" do
      optional :schedule, :string, 1
      repeated :rebalance_requests, :message, 2, "openstorage.api.SdkStorageRebalanceRequest"
    end
    add_message "openstorage.api.SdkCreateRebalanceScheduleResponse" do
      optional :scheduleInfo, :message, 1, "openstorage.api.RebalanceScheduleInfo"
    end
    add_message "openstorage.api.SdkGetRebalanceScheduleRequest" do
    end
    add_message "openstorage.api.SdkGetRebalanceScheduleResponse" do
      optional :scheduleInfo, :message, 1, "openstorage.api.RebalanceScheduleInfo"
    end
    add_message "openstorage.api.SdkDeleteRebalanceScheduleRequest" do
    end
    add_message "openstorage.api.SdkDeleteRebalanceScheduleResponse" do
    end
    ...
    add_message "openstorage.api.SdkCloudBackupCreateRequest" do
      ...
      optional :near_sync_migrate, :bool, 8
    end
    ...
    add_message "openstorage.api.SdkCloudBackupStatusRequest" do
      ...
      optional :near_sync_migrate, :bool, 4
    end
    ...
    add_message "openstorage.api.SdkCloudBackupSizeResponse" do
      optional :size, :uint64, 1
      optional :total_download_bytes, :uint64, 2
      optional :compressed_object_bytes, :uint64, 3
      optional :capacity_required_for_restore, :uint64, 4
    end
    ...
    add_message "openstorage.api.SdkVolumeBytesUsedResponse" do
      optional :vol_util_info, :message, 1, "openstorage.api.VolumeBytesUsedByNode"
    end
    add_message "openstorage.api.SdkVolumeBytesUsedRequest" do
      optional :node_id, :string, 1
      repeated :ids, :uint64, 2
    end
    add_message "openstorage.api.SdkFilesystemTrimStopResponse" do
    end
    add_message "openstorage.api.SdkAutoFSTrimPushRequest" do
      optional :volume_id, :string, 1
    end
    add_message "openstorage.api.SdkAutoFSTrimPushResponse" do
      optional :message, :string, 1
    end
    add_message "openstorage.api.SdkAutoFSTrimPopRequest" do
      optional :volume_id, :string, 1
    end
    add_message "openstorage.api.SdkAutoFSTrimPopResponse" do
      optional :message, :string, 1
    end
    ...
    add_message "openstorage.api.FilesystemCheckSnapInfo" do
      optional :volume_snapshot_name, :string, 1
    end
    add_message "openstorage.api.FilesystemCheckVolInfo" do
      optional :volume_name, :string, 1
      optional :health_status, :enum, 2, "openstorage.api.FilesystemHealthStatus"
      optional :fs_status_msg, :string, 3
    end
    ...
    add_message "openstorage.api.SdkFilesystemCheckListSnapshotsRequest" do
      optional :volume_id, :string, 1
      optional :node_id, :string, 2
    end
    add_message "openstorage.api.SdkFilesystemCheckListSnapshotsResponse" do
      map :snapshots, :string, :message, 1, "openstorage.api.FilesystemCheckSnapInfo"
    end
    add_message "openstorage.api.SdkFilesystemCheckDeleteSnapshotsRequest" do
      optional :volume_id, :string, 1
      optional :node_id, :string, 2
    end
    add_message "openstorage.api.SdkFilesystemCheckDeleteSnapshotsResponse" do
    end
    add_message "openstorage.api.SdkFilesystemCheckListVolumesRequest" do
      optional :node_id, :string, 1
    end
    add_message "openstorage.api.SdkFilesystemCheckListVolumesResponse" do
      map :volumes, :string, :message, 1, "openstorage.api.FilesystemCheckVolInfo"
    end
    ...
    add_message "openstorage.api.RestoreVolumeSpec" do
      ...
      optional :sharedv4_spec, :message, 28, "openstorage.api.Sharedv4Spec"
      optional :auto_fstrim, :enum, 29, "openstorage.api.RestoreParamBoolType"
      optional :io_throttle, :message, 30, "openstorage.api.IoThrottle"
      optional :readahead, :enum, 31, "openstorage.api.RestoreParamBoolType"
    end
    ...
    add_message "openstorage.api.VerifyChecksum" do
    end
    add_enum "openstorage.api.VerifyChecksum.VerifyChecksumStatus" do
      value :VERIFY_CHECKSUM_UNKNOWN, 0
      value :VERIFY_CHECKSUM_NOT_RUNNING, 1
      value :VERIFY_CHECKSUM_STARTED, 2
      value :VERIFY_CHECKSUM_STOPPED, 3
      value :VERIFY_CHECKSUM_COMPLETED, 4
      value :VERIFY_CHECKSUM_FAILED, 5
    end
    add_message "openstorage.api.SdkVerifyChecksumStartRequest" do
      optional :volume_id, :string, 1
    end
    add_message "openstorage.api.SdkVerifyChecksumStartResponse" do
      optional :status, :enum, 1, "openstorage.api.VerifyChecksum.VerifyChecksumStatus"
      optional :message, :string, 2
    end
    add_message "openstorage.api.SdkVerifyChecksumStatusRequest" do
      optional :volume_id, :string, 1
    end
    add_message "openstorage.api.SdkVerifyChecksumStatusResponse" do
      optional :status, :enum, 1, "openstorage.api.VerifyChecksum.VerifyChecksumStatus"
      optional :message, :string, 2
    end
    add_message "openstorage.api.SdkVerifyChecksumStopRequest" do
      optional :volume_id, :string, 1
    end
    add_message "openstorage.api.SdkVerifyChecksumStopResponse" do
      optional :message, :string, 1
    end
    ...
    add_enum "openstorage.api.IoProfile" do
      ...
      value :IO_PROFILE_JOURNAL, 8
      value :IO_PROFILE_AUTO_JOURNAL, 9
    end
    ...
    add_enum "openstorage.api.ProxyProtocol" do
      ...
      value :PROXY_PROTOCOL_PURE_BLOCK, 4
      value :PROXY_PROTOCOL_PURE_FILE, 5
    end
    ...
    add_enum "openstorage.api.NearSyncReplicationStrategy" do
      value :NEAR_SYNC_STRATEGY_NONE, 0
      value :NEAR_SYNC_STRATEGY_AGGRESSIVE, 1
      value :NEAR_SYNC_STRATEGY_OPTIMIZED, 2
    end
    add_enum "openstorage.api.AnonymousBucketAccessMode" do
      value :UnknownBucketAccessMode, 0
      value :Private, 1
      value :ReadOnly, 2
      value :WriteOnly, 3
      value :ReadWrite, 4
    ...
    add_enum "openstorage.api.SdkCloudBackupOpType" do
      ...
      value :SdkNearSyncOpTypeCloneOp, 3
      value :SdkNearSyncOpTypeReplAddOp, 4
      value :SdkNearSyncOpTypeRestoreOp, 5
    end
    add_enum "openstorage.api.SdkCloudBackupStatusType" do
      ...
      value :SdkNearSyncStatusTypeNotStarted, 10
      value :SdkNearSyncStatusTypeDone, 11
      value :SdkNearSyncStatusTypePaused, 12
      value :SdkNearSyncStatusTypeStopped, 13
      value :SdkNearSyncStatusTypeActive, 14
      value :SdkNearSyncStatusTypeFailed, 15
      value :SdkNearSyncStatusTypeInvalid, 16
    end
    add_enum "openstorage.api.SdkCloudBackupRequestedState" do
      ...
      value :SdkNearSyncRequestedStatePause, 4
      value :SdkNearSyncRequestedStateResume, 5
      value :SdkNearSyncRequestedStateStop, 6
    end
...
module Openstorage
  module Api
    ...
    SchedulerTopology = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SchedulerTopology").msgclass
    StoragePoolOperation = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.StoragePoolOperation").msgclass
    TopologyRequirement = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.TopologyRequirement").msgclass
    ...
    PureBlockSpec = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.PureBlockSpec").msgclass
    PureFileSpec = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.PureFileSpec").msgclass
    ...
    IoThrottle = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.IoThrottle").msgclass
    ...
    VolumeBytesUsed = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.VolumeBytesUsed").msgclass
    VolumeBytesUsedByNode = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.VolumeBytesUsedByNode").msgclass
    ...
    BucketCreateRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.BucketCreateRequest").msgclass
    BucketCreateResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.BucketCreateResponse").msgclass
    BucketDeleteRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.BucketDeleteRequest").msgclass
    BucketDeleteResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.BucketDeleteResponse").msgclass
    BucketGrantAccessRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.BucketGrantAccessRequest").msgclass
    BucketGrantAccessResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.BucketGrantAccessResponse").msgclass
    BucketRevokeAccessRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.BucketRevokeAccessRequest").msgclass
    BucketRevokeAccessResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.BucketRevokeAccessResponse").msgclass
    BucketAccessCredentials = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.BucketAccessCredentials").msgclass
    ...
    SdkCredentialUpdateRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkCredentialUpdateRequest").msgclass
    SdkCredentialUpdateResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkCredentialUpdateResponse").msgclass
    ...
    SdkNfsCredentialRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkNfsCredentialRequest").msgclass
    ...
    SdkNfsCredentialResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkNfsCredentialResponse").msgclass
    ...
    SdkWatchRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkWatchRequest").msgclass
    SdkWatchResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkWatchResponse").msgclass
    SdkVolumeWatchRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkVolumeWatchRequest").msgclass
    SdkVolumeWatchResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkVolumeWatchResponse").msgclass
    ...
    SdkNodeRelaxedReclaimPurgeRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkNodeRelaxedReclaimPurgeRequest").msgclass
    SdkNodeRelaxedReclaimPurgeResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkNodeRelaxedReclaimPurgeResponse").msgclass
    ...
    DefragJob = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.DefragJob").msgclass
    ...
    SdkStorageRebalanceRequest::Mode = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkStorageRebalanceRequest.Mode").enummodule
    ...
    RebalanceScheduleInfo = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.RebalanceScheduleInfo").msgclass
    SdkCreateRebalanceScheduleRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkCreateRebalanceScheduleRequest").msgclass
    SdkCreateRebalanceScheduleResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkCreateRebalanceScheduleResponse").msgclass
    SdkGetRebalanceScheduleRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkGetRebalanceScheduleRequest").msgclass
    SdkGetRebalanceScheduleResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkGetRebalanceScheduleResponse").msgclass
    SdkDeleteRebalanceScheduleRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkDeleteRebalanceScheduleRequest").msgclass
    SdkDeleteRebalanceScheduleResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkDeleteRebalanceScheduleResponse").msgclass
    ...
    SdkVolumeBytesUsedResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkVolumeBytesUsedResponse").msgclass
    SdkVolumeBytesUsedRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkVolumeBytesUsedRequest").msgclass
    ...
    SdkAutoFSTrimPushRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkAutoFSTrimPushRequest").msgclass
    SdkAutoFSTrimPushResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkAutoFSTrimPushResponse").msgclass
    SdkAutoFSTrimPopRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkAutoFSTrimPopRequest").msgclass
    SdkAutoFSTrimPopResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkAutoFSTrimPopResponse").msgclass
    ...
    FilesystemCheckSnapInfo = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.FilesystemCheckSnapInfo").msgclass
    FilesystemCheckVolInfo = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.FilesystemCheckVolInfo").msgclass
    ...
    SdkFilesystemCheckListSnapshotsRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkFilesystemCheckListSnapshotsRequest").msgclass
    SdkFilesystemCheckListSnapshotsResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkFilesystemCheckListSnapshotsResponse").msgclass
    SdkFilesystemCheckDeleteSnapshotsRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkFilesystemCheckDeleteSnapshotsRequest").msgclass
    SdkFilesystemCheckDeleteSnapshotsResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkFilesystemCheckDeleteSnapshotsResponse").msgclass
    SdkFilesystemCheckListVolumesRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkFilesystemCheckListVolumesRequest").msgclass
    SdkFilesystemCheckListVolumesResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkFilesystemCheckListVolumesResponse").msgclass
    ...
    VerifyChecksum = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.VerifyChecksum").msgclass
    VerifyChecksum::VerifyChecksumStatus = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.VerifyChecksum.VerifyChecksumStatus").enummodule
    SdkVerifyChecksumStartRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkVerifyChecksumStartRequest").msgclass
    SdkVerifyChecksumStartResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkVerifyChecksumStartResponse").msgclass
    SdkVerifyChecksumStatusRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkVerifyChecksumStatusRequest").msgclass
    SdkVerifyChecksumStatusResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkVerifyChecksumStatusResponse").msgclass
    SdkVerifyChecksumStopRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkVerifyChecksumStopRequest").msgclass
    SdkVerifyChecksumStopResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.SdkVerifyChecksumStopResponse").msgclass
    ...
    NearSyncReplicationStrategy = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.NearSyncReplicationStrategy").enummodule
    AnonymousBucketAccessMode = Google::Protobuf::DescriptorPool.generated_pool.lookup("openstorage.api.AnonymousBucketAccessMode").enummodule
